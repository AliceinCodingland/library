...
* Introduction
** Purpose
To create a new library reserve request form that improves upon the
functionality of the previous /Portal/ edition.
** Definitions
...
powered by the [[http://www.example.com/gravity-forms][Gravity Forms]] plugin.  Users (the faculty and staff of
